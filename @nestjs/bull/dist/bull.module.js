...
let BullModule = BullModule_1 = class BullModule {
    ...
    static forRoot(keyOrConfig, bullConfig) {
        ...
        const sharedBullConfigProvider = {
            provide: (0, bull_shared_1.getSharedConfigToken)(configKey),
    ...
    static createAsyncProviders(options) {
        const optionalSharedConfigHolder = (0, bull_shared_1.createConditionalDepHolder)((0, bull_shared_1.getSharedConfigToken)(options.configKey));
    ...
    static createAsyncOptionsProvider(asyncOptions, optionalSharedConfigHolderRef) {
        if (asyncOptions.useFactory) {
            return {
                provide: (0, bull_shared_1.getQueueOptionsToken)(asyncOptions.name),
